...
/dafu (main CLI script)
  ├── calls → core/features/fraud_detection/src/api/cli.py (for API commands)
  ├── calls → core/features/fraud_detection/src/models/main.py (for ML)
...
4. Activates virtual environment in `core/features/fraud_detection/`
